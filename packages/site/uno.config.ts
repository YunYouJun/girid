...
export default defineConfig({
  ...
  shortcuts: [
    ...
    ['girid-btn', 'border border-rounded border-2px px-4 py-2 w-full rounded inline-block cursor-pointer disabled:cursor-not-allowed disabled:opacity-30 disabled:hover:bg-dark-300'],
  ],
  presets: [
    presetUno(),
    presetAttributify(),
