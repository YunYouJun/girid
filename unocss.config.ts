...
export default defineConfig({
  shortcuts: [
    ...
    ['girid-btn', 'border border-rounded border-2px px-4 py-2 w-full rounded inline-block cursor-pointer disabled:cursor-not-allowed disabled:bg-gray-200 disabled:opacity-20 disabled:hover:bg-gray-200'],
  ],
  presets: [
    presetUno(),
    presetAttributify(),
